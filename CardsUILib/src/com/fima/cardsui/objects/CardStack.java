...
public class CardStack extends AbstractCard {
	...
	public View getView(Context context, boolean swipable) {
		...
		final RelativeLayout container = (RelativeLayout) view.findViewById(R.id.stackContainer);
		...
		for (int i = 0; i < cardsArraySize; i++) {
			...
			if (swipable) {
				cardView.setOnTouchListener(new SwipeDismissTouchListener(cardView, card, new OnDismissCallback() {
	...
	private OnClickListener getClickListener(final CardStack cardStack, final RelativeLayout container, final int index) {
		return new OnClickListener() {
			...
			public void onClickFirstCard(final CardStack cardStack, final RelativeLayout frameLayout, final int index,
				View[] views) {
			...
			public void onClickOtherCard(final CardStack cardStack, final RelativeLayout frameLayout, final int index,
				View[] views, int last) {
	...
	private AnimatorListener getAnimationListener(final CardStack cardStack, final RelativeLayout frameLayout,
		final int index, final View clickedCard) {
		return new AnimatorListener() {
			...
			public void onAnimationStart(Animator animation) {
				if (index == 0) {
					...
					clickedCard.setBackgroundResource(com.fima.cardsui.R.drawable.card_background);
				}
