...
class ViewPropertyAnimatorICS extends ViewPropertyAnimator {
	...
	ViewPropertyAnimatorICS(View view) {
		android.view.ViewPropertyAnimator vpa = null;
		if (view != null) {
			vpa = view.animate();
		}
		mNative = new WeakReference<android.view.ViewPropertyAnimator>(vpa);
	}
	...
	public long getDuration() {
		android.view.ViewPropertyAnimator n = mNative.get();
		if (n != null) return n.getDuration();
	...
	public long getStartDelay() {
		android.view.ViewPropertyAnimator n = mNative.get();
		if (n != null) return n.getStartDelay();
		return RETURN_WHEN_NULL;
	}
