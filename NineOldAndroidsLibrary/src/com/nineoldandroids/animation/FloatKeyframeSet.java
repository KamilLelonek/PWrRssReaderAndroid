...
class FloatKeyframeSet extends KeyframeSet {
	...
	public float getFloatValue(float fraction) {
		if (mNumKeyframes == 2) {
			...
			if (mEvaluator == null) return firstValue + fraction * deltaValue;
		...
		if (fraction <= 0f) {
			...
			return mEvaluator == null ? prevValue + intervalFraction * (nextValue - prevValue) : ((Number) mEvaluator
				.evaluate(intervalFraction, prevValue, nextValue)).floatValue();
		}
		else if (fraction >= 1f) {
