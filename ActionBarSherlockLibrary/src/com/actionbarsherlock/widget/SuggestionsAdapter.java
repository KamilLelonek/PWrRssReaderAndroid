...
class SuggestionsAdapter extends ResourceCursorAdapter implements OnClickListener {
	...
	public Cursor runQueryOnBackgroundThread(CharSequence constraint) {
		 ...
		 */
		Cursor cursor = null;
		if (mSearchView.getVisibility() != View.VISIBLE || mSearchView.getWindowVisibility() != View.VISIBLE) return null;
	...
	public Cursor getSuggestions(String query, int limit) {
		if (mSearchable == null) return null;
	 ...
	 * 
	 * @param cursor The Cursor to read the suggestion data from. The Cursor
	 *        should already be moved to the suggestion that is to be read from.
	...
	public Drawable getTheDrawable(Uri uri) throws FileNotFoundException {
		...
		Resources r;
		if (TextUtils.isEmpty(authority)) throw new FileNotFoundException("No authority: " + uri);
		else {
			try {
		...
		else throw new FileNotFoundException("More than two path segments: " + uri);
