...
public class ShareActionProvider extends ActionProvider {
		...
		if (collapsedActivityCount < expandedActivityCount) {
			...
			for (int i = 0; i < expandedActivityCount; i++) {
				...
				expandedSubMenu.add(0, i, i, activity.loadLabel(packageManager))
					.setIcon(activity.loadIcon(packageManager)).setOnMenuItemClickListener(mOnMenuItemClickListener);
			}
		}
	}
	...
	private void setActivityChooserPolicyIfNeeded() {
		if (mOnShareTargetSelectedListener == null) return;
	...
	private class ShareAcitivityChooserModelPolicy implements OnChooseActivityListener {
		...
		public boolean onChooseActivity(ActivityChooserModel host, Intent intent) {
			if (mOnShareTargetSelectedListener != null) return mOnShareTargetSelectedListener.onShareTargetSelected(
