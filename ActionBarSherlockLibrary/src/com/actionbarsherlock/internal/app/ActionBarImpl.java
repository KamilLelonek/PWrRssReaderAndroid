...
public class ActionBarImpl extends ActionBar {
	...
	private void init(View decor) {
		...
		if (mActionView == null || mContextView == null || mContainerView == null) throw new IllegalStateException(
	...
	private void configureTab(Tab tab, int position) {
		...
		if (callback == null) throw new IllegalStateException("Action Bar Tab must have a Callback");
	...
	public void removeTabAt(int position) {
		if (mTabScrollView == null) // No tabs around to remove
		return;
	...
	public void hide() {
		...
		if (mContainerView.getVisibility() == View.GONE) return;
	...
	public class ActionModeImpl extends ActionMode implements MenuBuilder.Callback {
		...
		@Override
		public void finish() {
			if (mActionMode != this) // Not the active action mode - no-op
			return;
		...
		public boolean onMenuItemSelected(MenuBuilder menu, MenuItem item) {
			if (mCallback != null) return mCallback.onActionItemClicked(this, item);
			return false;
		}
		...
		public boolean onSubMenuSelected(SubMenuBuilder subMenu) {
			...
			if (!subMenu.hasVisibleItems()) return true;
