...
public final class MenuItemImpl implements MenuItem {
	 ...
	 *        all other items whose order is <= this number, and before any that
	 *        are larger than it. This can also be used to define groups of
	 *        items for batch state changes. Normally use 0.
	...
	public boolean invoke() {
		...
		if (mActionProvider != null && mActionProvider.onPerformDefaultAction()) return true;
	...
	public Drawable getIcon() {
		...
		if (mIconResId != NO_ICON) return mMenu.getResources().getDrawable(mIconResId);
	...
	public boolean expandActionView() {
		...
		if (mOnActionExpandListener == null || mOnActionExpandListener.onMenuItemActionExpand(this)) return mMenu
	...
	public boolean collapseActionView() {
		...
		if (mActionView == null) // We're already collapsed if we have no action view.
		return true;
		
		if (mOnActionExpandListener == null || mOnActionExpandListener.onMenuItemActionCollapse(this)) return mMenu
