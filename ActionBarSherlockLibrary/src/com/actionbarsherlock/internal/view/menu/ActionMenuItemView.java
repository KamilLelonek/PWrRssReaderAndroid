...
public class ActionMenuItemView extends LinearLayout implements MenuView.ItemView, View.OnClickListener,
	...
	public boolean dispatchHoverEvent(MotionEvent event) {
		...
		if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.ICE_CREAM_SANDWICH) return onHoverEvent(event);
		return false;
	}
	...
	public boolean onLongClick(View v) {
		if (hasText()) // Don't show the cheat sheet for items that already show text.
		return false;
