...
public interface MenuView {
	...
	public interface ItemView {
		 ...
		 * 
		 * @param showShortcut Whether a shortcut should be shown(if false, the
		 *        value of shortcutKey should be ignored).
		 * @param shortcutKey The shortcut key that should be shown on the
		 *        ItemView.
		 */
