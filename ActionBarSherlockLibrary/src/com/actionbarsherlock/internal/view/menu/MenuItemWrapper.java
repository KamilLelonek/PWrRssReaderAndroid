...
public class MenuItemWrapper implements MenuItem, android.view.MenuItem.OnMenuItemClickListener {
	...
	public MenuItemWrapper(android.view.MenuItem nativeItem) {
		if (nativeItem == null) throw new IllegalStateException("Wrapped menu item cannot be null.");
	...
	public boolean onMenuItemClick(android.view.MenuItem item) {
		if (mMenuItemClickListener != null) return mMenuItemClickListener.onMenuItemClick(this);
		return false;
	}
	...
	public View getActionView() {
		...
		if (actionView instanceof CollapsibleActionViewWrapper) return ((CollapsibleActionViewWrapper) actionView)
			.unwrap();
		return actionView;
	}
	...
	public ActionProvider getActionProvider() {
		...
		if (nativeProvider != null && nativeProvider instanceof ActionProviderWrapper) return ((ActionProviderWrapper) nativeProvider)
			.unwrap();
		return null;
	}
		...
		if (mNativeActionExpandListener == null) {
			mNativeActionExpandListener = new android.view.MenuItem.OnActionExpandListener() {
				...
				public boolean onMenuItemActionExpand(android.view.MenuItem menuItem) {
					if (mActionExpandListener != null) return mActionExpandListener
