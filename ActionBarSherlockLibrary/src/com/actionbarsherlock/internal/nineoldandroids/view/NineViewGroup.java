...
public abstract class NineViewGroup extends ViewGroup {
	...
	public float getAlpha() {
		if (AnimatorProxy.NEEDS_PROXY) return mProxy.getAlpha();
	...
	public float getTranslationX() {
		if (AnimatorProxy.NEEDS_PROXY) return mProxy.getTranslationX();
	...
	public float getTranslationY() {
		if (AnimatorProxy.NEEDS_PROXY) return mProxy.getTranslationY();
