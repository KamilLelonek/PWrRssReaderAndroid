...
public class IcsListPopupWindow {
	...
	private int buildDropDown() {
		...
		if (mDropDownHeight == ViewGroup.LayoutParams.MATCH_PARENT) return maxHeight + padding;
	...
	private int measureHeightOfChildren(int widthMeasureSpec, int startPosition, int endPosition, final int maxHeight,
		...
		if (adapter == null) return mDropDownList.getListPaddingTop() + mDropDownList.getListPaddingBottom();
		...
		for (i = startPosition; i <= endPosition; ++i) {
			...
			if (returnedHeight >= maxHeight) // We went over, figure out which height to return.  If returnedHeight > maxHeight,
