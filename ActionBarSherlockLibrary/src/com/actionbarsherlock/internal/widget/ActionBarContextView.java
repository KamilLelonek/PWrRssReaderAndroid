...
public class ActionBarContextView extends AbsActionBarView implements AnimatorListener {
	...
	public void closeMode() {
		if (mAnimationMode == ANIMATE_OUT) // Called again during close; just finish what we were doing.
		return;
		if (mClose == null) {
			killMode();
			return;
	...
	public boolean showOverflowMenu() {
		if (mActionMenuPresenter != null) return mActionMenuPresenter.showOverflowMenu();
		return false;
	}
	
	@Override
	public boolean hideOverflowMenu() {
		if (mActionMenuPresenter != null) return mActionMenuPresenter.hideOverflowMenu();
		return false;
	}
	
	@Override
	public boolean isOverflowMenuShowing() {
		if (mActionMenuPresenter != null) return mActionMenuPresenter.isOverflowMenuShowing();
		return false;
	}
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		if (widthMode != MeasureSpec.EXACTLY) throw new IllegalStateException(getClass().getSimpleName()
			+ " can only be used " + "with android:layout_width=\"match_parent\" (or fill_parent)");
		
		final int heightMode = MeasureSpec.getMode(heightMeasureSpec);
		if (heightMode == MeasureSpec.UNSPECIFIED) throw new IllegalStateException(getClass().getSimpleName()
