...
public class IcsProgressBar extends View {
	...
	private static final int[] ProgressBar = new int[] { android.R.attr.maxWidth, android.R.attr.maxHeight,
		...
		android.R.attr.indeterminateDuration, android.R.attr.indeterminateBehavior, android.R.attr.minWidth,
		android.R.attr.minHeight, android.R.attr.interpolator, android.R.attr.animationResolution, };
	 ...
	 * </p>
	 * 
	 * @param secondaryProgress the new secondary progress, between 0 and
	 *        {@link #getMax()}
	 * @see #setIndeterminate(boolean)
	 * @see #isIndeterminate()
