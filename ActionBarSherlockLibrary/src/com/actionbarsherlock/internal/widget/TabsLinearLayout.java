...
public class TabsLinearLayout extends IcsLinearLayout {
	...
	public TabsLinearLayout(Context context, AttributeSet attrs) {
		...
		mUseLargestChild = a.getBoolean(/*com.android.internal.R.styleable.*/LinearLayout_measureWithLargestChild,
			false);
	 ...
	 * Disabled by default.
	 * 
	 * @param enabled True to measure children with a weight using the minimum
