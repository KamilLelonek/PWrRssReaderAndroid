...
public class ScrollingTabContainerView extends NineHorizontalScrollView implements
	...
	private IcsLinearLayout createTabLayout() {
		...
		tabLayout.setLayoutParams(new LinearLayout.LayoutParams(android.view.ViewGroup.LayoutParams.WRAP_CONTENT,
	...
	private IcsSpinner createSpinner() {
		...
		spinner.setLayoutParams(new LinearLayout.LayoutParams(android.view.ViewGroup.LayoutParams.WRAP_CONTENT,
			android.view.ViewGroup.LayoutParams.MATCH_PARENT));
	...
	public void addTab(ActionBar.Tab tab, int position, boolean setSelected) {
		...
		mTabLayout.addView(tabView, position, new IcsLinearLayout.LayoutParams(0,
			android.view.ViewGroup.LayoutParams.MATCH_PARENT, 1));
		if (mTabSpinner != null) {
			((TabAdapter) mTabSpinner.getAdapter()).notifyDataSetChanged();
		}
