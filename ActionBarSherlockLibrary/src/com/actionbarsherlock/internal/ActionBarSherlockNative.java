...
public class ActionBarSherlockNative extends ActionBarSherlock {
	...
	private void initActionBar() {
		if (mActionBar != null || mActivity.getActionBar() == null) return;
	...
	public boolean dispatchOptionsItemSelected(android.view.MenuItem item) {
		...
		MenuItem wrapped;
		if (mMenu == null) {
			if (item.getItemId() != android.R.id.home) throw new IllegalStateException(
				"Non-home action item clicked before onCreateOptionsMenu with ID " + item.getItemId());
