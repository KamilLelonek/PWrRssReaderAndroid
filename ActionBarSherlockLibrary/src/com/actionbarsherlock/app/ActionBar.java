...
public abstract class ActionBar {
	 ...
	 *        current navigation selection and populate views within the
	 ...
	 * methods.
	 * 
	 * @param useLogo true to use the activity logo, false to use the activity
	 *        icon.
	 * 
	 * @see #setDisplayOptions(int)
	 * @see #setDisplayOptions(int, int)
	 ...
	 * methods.
	 * 
	 * @param showCustom true if the currently set custom view should be
	 ...
	 * 
	 * @param enabled true to enable the home button, false to disable the home
	 *        button.
	 */
	...
	public static abstract class Tab {
		 ...
		 * not room to display the entire string.
		 * 
		 * @param resId A resource ID referring to the text that should be
		 *        displayed
		 * @return The current instance for call chaining
		 */
	...
	public interface TabListener {
		 ...
		 * @param ft A {@link FragmentTransaction} for queuing fragment
		 *        operations to execute during a tab switch. The previous tab's
		 *        unselect and this tab's select will be executed in a single
		 *        transaction. This FragmentTransaction does not support being
		 ...
		 * @param ft A {@link FragmentTransaction} for queuing fragment
		 *        operations to execute during a tab switch. This tab's unselect
		 *        and the newly selected tab's select will be executed in a
		 *        single transaction. This FragmentTransaction does not support
		 ...
		 *        FragmentTransaction does not support being added to the back
		 *        stack.
		 */
