...
public interface MenuItem {
	 ...
	 * 
	 * @see #getIntent
	 * @param intent The Intent to associated with the item. This Intent object
	 *        is <em>not</em> copied, so be careful not to modify it later.
	 * @return This Item so additional setters can be called.
	 */
	 ...
	 * 
	 * @param checkable Set to true to allow a check mark, false to disallow.
	 ...
	 * @see #isChecked
	 * @see Menu#setGroupCheckable
	 * @param checked Set to true to display a check mark, false to hide it. The
	 ...
	 *        {@link #SHOW_AS_ACTION_ALWAYS}, {@link #SHOW_AS_ACTION_IF_ROOM},
	 *        or {@link #SHOW_AS_ACTION_NEVER}. SHOW_AS_ACTION_NEVER is the
	 *        default.
	 * 
