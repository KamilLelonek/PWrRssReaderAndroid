...
public interface Menu {
	 ...
	 *        checked at a time; checking an item will automatically uncheck all
	 *        others in the group. If set to false, each item can be checked
	 ...
	 * 
	 * @param group The group of items to operate on.
	 * @param enabled If true the items will be enabled, else they will be
	 *        disabled.
	 * 
