/* Copyright (C) 2006 The Android Open Source Project 2011 Jake Wharton Licensed
	...
	private class MenuState {
		...
		private void setItem(MenuItem item) {
			...
			if (itemListenerMethodName != null) {
				if (mContext.isRestricted()) throw new IllegalStateException("The android:onClick attribute cannot "
